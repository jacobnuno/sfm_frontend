<template>
    <section id="smf-create-complex">
        <form @submit.prevent="beforeCreateComplex" class="col-sm-12 col-md-10 offset-md-1">
            <h2 class="create-title">Crear una Unidad</h2>
            ...
            <div class="text-center buttons">
                <div class="form-group">
                    <button type="submit" value="Submit" tabindex=8 class="btn btn-primary">Guardar</button>
