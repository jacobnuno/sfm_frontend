<template>
    <section id="smf-create-matches">
        <form @submit.prevent="beforeCreateMatch" class="col-sm-12 col-md-6 offset-md-3">
            <h2 class="create-title">Crear un Partido</h2>
...
export default {
    ...
    methods: {
        notifyVue (verticalAlign, horizontalAlign, msg, color) {
         ...
         ...mapActions({
            createMatch: matchTypes.actions.createMatch,
