        ...
        <form @submit.prevent="beforeUpdateUser" class="col-sm-12 col-md-6 offset-md-3">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-12 col-md-6">
                    ...
                    <input type="password" autocomplete="off" class="form-control" id="Password" v-model="Password" v-validate="'required|min:6'" data-vv-name="Password" placeholder="Ingresa la contraseña">
                ...
                <div class="form-group col-sm-12 col-md-6">
                    ...
                    <select class="form-control" id="UserType" name="UserType" v-model="UserType" required>
                        ...
                        <option v-for="option in userTypesOptions" :key="option.value" :value="option.value" :selected="option.value == UserType">{{ option.text }}</option>
                    </select>
                </div>
            </div>
    ...
    methods: {
        ...
        getData() {
            ...
            .then(user => {
                ...
                this.UserType = user.data.data["User Type"].id
            })
