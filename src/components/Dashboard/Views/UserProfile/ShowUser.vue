      ...
      <div class="row">
        <div class="col-sm-12 col-md-6 offset-md-3">
          <card>
            ...
            <router-link class="btn btn-warning btn-close" :to="{ name: 'EditUserProfile', params: { id:  id} }">
              Editar
            </router-link>

            <router-link class="btn btn-danger btn-close float-right" :to="{ name: 'Overview' }">
              Cerrar
            </router-link>
          </card>
        </div>
